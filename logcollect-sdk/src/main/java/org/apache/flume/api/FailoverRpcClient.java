...
public class FailoverRpcClient extends AbstractRpcClient implements RpcClient {
   ...
   */
  @Override
  public synchronized void close() throws EventException {
    if (client != null) {
      client.close();
      isActive = false;
    }
  ...
  private RpcClient getNextClient() throws EventException {
    lastCheckedhost =
    ...
    if (localClient == null) {
      ...
      throw new EventException("No active client.");
    }
  ...
  @Override
  public void configure(Properties properties) throws EventException {
