...
public class DefaultSourceFactory implements SourceFactory {
  ...
  @Override
  public Source create(String name, String type) throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to create source: " + name
  ...
  throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to load source type: " + type
