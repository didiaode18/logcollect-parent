...
public abstract class BasicSourceSemantics implements Source, Configurable {
  ...
  protected abstract void doConfigure(Context context) throws EventException;
  protected abstract void doStart() throws EventException;
  protected abstract void doStop() throws EventException;
}