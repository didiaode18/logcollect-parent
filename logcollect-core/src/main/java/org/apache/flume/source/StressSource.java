...
import org.apache.logcollect.event.EventBuilder;
...
public class StressSource extends AbstractPollableSource implements
   ...
   */
  @Override
  protected void doConfigure(Context context) throws EventException {
  ...
  @Override
  protected void doStart() throws EventException {
    logger.info("Stress source doStart finished");
  }

  @Override
  protected void doStop() throws EventException {
