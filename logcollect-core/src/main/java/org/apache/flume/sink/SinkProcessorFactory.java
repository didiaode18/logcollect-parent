...
public class SinkProcessorFactory {
   ...
   * @throws EventException Runtime exception thrown in the case of an invalid
 ...
 List<Sink> sinks) {
    ...
    try {
      ...
      throw new EventException("Unable to load sink processor type: " + typeStr
          + ", class: " + type.getSinkProcessorClassName(), ex);
    }
    try {
      processor = processorClass.newInstance();
    } catch (Exception e) {
      throw new EventException("Unable to create sink processor, type: " + typeStr
  ...
  public static SinkProcessor getProcessor(ComponentConfiguration conf,
    ...
    try {
      ...
      throw new EventException("Unable to create processor, type: " + typeStr
