...
public class DefaultSinkFactory implements SinkFactory {
  ...
  @Override
  public Sink create(String name, String type) throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to create sink: " + name
  ...
  throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to load sink type: " + type
