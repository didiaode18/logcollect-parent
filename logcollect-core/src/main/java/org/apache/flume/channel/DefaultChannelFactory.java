...
public class DefaultChannelFactory implements ChannelFactory {
  ...
  @Override
  public Channel create(String name, String type) throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to create channel: " + name
  ...
  throws EventException {
    ...
    try {
      ...
      throw new EventException("Unable to load channel type: " + type
